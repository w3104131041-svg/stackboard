...
export default async function HomePage() {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-20 px-4 py-8 md:space-y-28 md:px-6 md:py-16">
      <section className="hero-shell relative overflow-hidden rounded-[1.75rem] px-6 py-10 md:rounded-[2.25rem] md:px-14 md:py-24">
        <div className="hero-grid" />
        <div className="hero-glow hero-glow-1" />
        <div className="hero-glow hero-glow-2" />

        <div className="relative z-10 grid gap-8 md:grid-cols-[1.2fr_0.8fr] md:items-end md:gap-14">
          <div className="max-w-3xl">
            <p className="text-[10px] uppercase tracking-[0.32em] text-emerald-300/75 md:text-[11px] md:tracking-[0.36em]">
              SWITCH YOUR STACK.
            </p>

            <h1 className="mt-5 text-4xl font-semibold leading-[0.96] tracking-[-0.05em] text-white md:mt-6 md:text-7xl">
              仲間内でも、
              <br />
              ちゃんとした
              <br />
            ...
            <p className="mt-6 max-w-2xl text-sm leading-7 text-white/62 md:mt-8 md:text-base">
              開催、結果、収支、ランキング。
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row md:mt-10 md:gap-4">
              ...
              <Link
                href="/rankings"
                className="btn-outline inline-flex items-center justify-center rounded-full px-6 py-3 text-sm font-semibold"
              >
                ランキングを見る
              </Link>
            </div>
          ...
          <div className="glass-card rounded-[1.5rem] p-5 md:rounded-[1.8rem] md:p-7">
            <p className="text-[10px] uppercase tracking-[0.28em] text-white/42 md:text-[11px] md:tracking-[0.3em]">
              NEXT EVENT
            </p>
      ...
      <section className="grid gap-8 md:grid-cols-[0.78fr_1.22fr] md:items-start md:gap-10">
        <div>
          <p className="text-[10px] uppercase tracking-[0.3em] text-emerald-300/75 md:text-[11px] md:tracking-[0.34em]">
            PHILOSOPHY
          </p>
          <h2 className="mt-4 text-4xl font-semibold leading-[1.02] tracking-[-0.04em] text-white md:text-5xl">
            遊びを、
            <br />
            記録に変える。
          </h2>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {recentResults.map((event: RecentResultEvent) => (
              ...
              >
                ...
                <h3 className="mt-6 text-xl font-semibold tracking-[-0.03em] text-white md:text-2xl">
                  {event.title}
                </h3>
      ...
      <section className="grid gap-8 md:grid-cols-[0.78fr_1.22fr] md:items-start md:gap-10">
        ...
        <div className="soft-card rounded-[1.9rem] p-6 md:p-10">
          <p className="text-sm leading-8 text-white/66 md:text-base">
        ...
        {top3.length === 0 ? (
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {top3.map((player: RankingPlayer, index: number) => (
              <div
                key={player.user_id}
                className={`${index === 0 ? 'neon-card' : 'soft-card'} rounded-[1.8rem] p-6 md:p-7`}
              >
                <div className="flex items-center justify-between">
                ...
                <div className="mt-8">
                  ...
                  <p className="mt-4 text-3xl font-semibold tracking-[-0.05em] text-white md:text-4xl">
      ...
      <section className="hero-shell relative overflow-hidden rounded-[1.75rem] px-6 py-10 md:rounded-[2rem] md:px-12 md:py-16">
        <div className="hero-grid" />
        <div className="hero-glow hero-glow-1" />
